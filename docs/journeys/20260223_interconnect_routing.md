...
| :--- | ---: | ---: | ---: | ---: |
| DIMM0 → DIMM2 | 20,855 | 5 | 16.0 | 0.16 |
| DIMM2 → DIMM0 | 21,652 | 6 | 19.2 | 0.16 |
| DIMM2 → DIMM1 | 36,665 | 7 | 22.4 | 0.28 |
| DIMM1 → DIMM2 | 29,286 | 6 | 19.2 | 0.22 |
| DIMM1 → DIMM3 | 22,371 | 7 | 22.4 | 0.17 |
| DIMM3 → DIMM1 | 20,288 | 5 | 16.0 | 0.15 |

DIMM 2 → DIMM 1 carries the most traffic (36,665 messages). DIMM 2 sits at position 1 in the line `[0, 2, 1, 3]`, so it forwards both DIMM 0's outbound traffic and DIMM 3's inbound traffic toward the center. Maximum flit overlap hits 7 concurrently active flit transfers (22.4 GB/s).
